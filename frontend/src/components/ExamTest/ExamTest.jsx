...
function ExamTestSession({ data = {}, durationSeconds, onSubmit }) {
    ...
    return (
      <div className="exam-shell">
        <div className="exam-layout">
          <GoBack />
          <div className="exam-empty">Đề thi này chưa có câu hỏi để học sinh làm bài.</div>
        </div>
      </div>
    );
  }
        ...
        <div className="exam-header">
          <div className="exam-header__top">
            ...
            <div className="exam-header__actions">
              <button className="exam-submit" type="button" onClick={handleSubmit}>
                Nộp bài
              </button>
            </div>
          </div>
        ...
        <div className="exam-main">
          ...
          <section className="exam-card">
            ...
            {currentQuestion.imgUrl && (
              <img
                alt={`Minh họa câu ${currentQuestionIndex + 1}`}
...
function ExamTest({ data = {}, onSubmit }) {
  ...
  return (
    <ExamTestSession
      key={`${data.id ?? "draft"}-${durationSeconds}`}
      data={data}
