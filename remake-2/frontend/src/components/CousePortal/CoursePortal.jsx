...
export default function CoursePortal() {
    ...
    const fetchCourses = async () => {
      try {
        const response = await axios.get(
          `http://localhost:3000/api/courses?grade=${selectedGrade}`,
        );
        if (isMounted) {
  ...
  if (loadedGrade !== selectedGrade) {
    return <div className="container-center text-center mt-10">Đang tải dữ liệu khóa học...</div>;
  }
    ...
    <div className="portal-container">
      ...
      <div className="portal-content">
        <div className="portal-header">
          <h1 className="portal-title">Cổng khóa học {selectedGrade.toLowerCase()}</h1>
          <button
            ...
            <div key={course.id} className="course-card">
              <div
                ...
                style={{
                  ...
                  backgroundImage: course.img_url
                    ? `url(http://localhost:3000${course.img_url})`
                    : "none",
